...
Command: npx gltfjsx@6.2.3 public\models\mac.gltf
*/
...
export function Mac(props) {
  const { nodes, materials } = useGLTF('./models/mac.gltf')
  return (
    <group {...props} dispose={null}>
      <Html wrapperClass='mac' position={[0, 1.5, -1.4]} transform rotation-x={-.25} distanceFactor={1.19}>
...
useGLTF.preload('./models/mac.gltf')
